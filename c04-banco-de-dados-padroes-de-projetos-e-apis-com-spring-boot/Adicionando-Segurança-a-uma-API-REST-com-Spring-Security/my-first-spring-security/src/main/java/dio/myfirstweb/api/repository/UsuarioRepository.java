...
import dio.myfirstweb.api.handler.BusinessException;
import dio.myfirstweb.api.handler.CampoObrigatorioExcept;
...
public class UsuarioRepository {
    ...
    public void save(Usuario usuario){
        if (usuario.getLogin() == null){
            throw new CampoObrigatorioExcept("login");
        }
        if (usuario.getPassword() == null){
            throw new CampoObrigatorioExcept("password");
        }
